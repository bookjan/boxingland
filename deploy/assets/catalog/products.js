(() => {
  ...
  const catalogPages = (folder, count, start = 1) => Array.from(
    { length: count },
    (_, index) => `assets/catalog/pdf/split/${folder}/page-${String(start + index).padStart(3, '0')}.pdf`
  );
  ...
  const products = [
    ...
    { id: 6, brand: 'GYMXF', cat: '地墊牆墊', title: 'Gym Flooring / Rubber Tiles', desc: '健身房橡膠地墊、拼接地材與訓練區鋪面。', img: 'assets/catalog/gymxf-flooring.jpg', pdf: 'assets/catalog/pdf/split/gymxf/page-045.pdf', pdfs: catalogPages('gymxf', 2, 45) },
    ...
    { id: 11, brand: 'GYMXF', cat: '商用健身', title: 'Rig Combination Series 1', desc: '模組化 RIG 系統，適合商用健身房與功能訓練區。', img: 'assets/catalog/gymxf-rig.jpg', pdf: 'assets/catalog/pdf/split/gymxf/page-003.pdf' },
    ...
    { id: 13, brand: 'GYMXF', cat: '商用健身', title: 'Functional Trainer / Cable Machine', desc: '多功能滑輪訓練機與商用繩索訓練設備。', img: 'assets/catalog/gymxf-functional-trainer.jpg', pdf: 'assets/catalog/pdf/split/gymxf/page-013.pdf' },
    ...
    { id: 19, brand: 'GYMXF', cat: '自由重量', title: 'Bars / Barbells / Specialty Bars', desc: '槓鈴、特殊槓與自由重量訓練配件。', img: 'assets/catalog/gymxf-bars.jpg', pdf: 'assets/catalog/pdf/split/gymxf/page-029.pdf', pdfs: catalogPages('gymxf', 6, 29) },
    { id: 20, brand: 'GYMXF', cat: '自由重量', title: 'Bumper Plates / 彩色槓片', desc: '競技槓片、彩色槓片與配重選項。', img: 'assets/catalog/gymxf-bumper-plates.jpg', pdf: 'assets/catalog/pdf/split/gymxf/page-036.pdf' },
    { id: 21, brand: 'GYMXF', cat: '自由重量', title: 'Medicine Balls / Wall Balls', desc: '藥球、牆球與體能訓練球類。', img: 'assets/catalog/gymxf-balls.jpg', pdf: 'assets/catalog/pdf/split/gymxf/page-042.pdf' },
    ...
    { id: 23, brand: 'GYMPAC', cat: '自由重量', title: 'Dumbbells / Kettlebells', desc: '啞鈴、壺鈴、彩色槓片與自由重量套組。', img: 'assets/catalog/gympac-dumbbells.jpg', pdf: 'assets/catalog/pdf/split/gympac/page-024.pdf', pdfs: catalogPages('gympac', 3, 24) },
    ...
    { id: 27, brand: 'CROSSMAX', cat: '兒童學校', title: '敏捷梯 / 標誌盤 / 訓練欄', desc: '兒童體能、協調與敏捷訓練用小器材。', img: 'assets/catalog/kids-agility.jpg', pdf: 'assets/catalog/pdf/split/kids/page-006.pdf' },
    { id: 28, brand: 'CROSSMAX', cat: '兒童學校', title: '跳球 / 觸覺球 / 軟式球類', desc: '兒童訓練用球類、感統器材與遊戲式訓練配件。', img: 'assets/catalog/kids-balls.jpg', pdf: 'assets/catalog/pdf/split/kids/page-007.pdf' },
    ...
    { id: 35, brand: 'CROSSMAX', cat: '完整型錄', title: 'CROSSMAX Commercial Fitness / 完整型錄', desc: 'CROSSMAX 商用健身、功能訓練、拳擊設備、地材與場地案例，共 80 頁。', img: 'assets/catalog/crossmax-gym-case.jpg', pdf: 'assets/catalog/pdf/split/crossmax/page-001.pdf', pdfs: catalogPages('crossmax', 80) },
    { id: 36, brand: 'GYMPAC', cat: '完整型錄', title: 'GYMPAC Commercial Fitness / 完整型錄', desc: 'GYMPAC 訓練椅、機架、RIG、自由重量、配件與地材，共 39 頁。', img: 'assets/catalog/gympac-rig.jpg', pdf: 'assets/catalog/pdf/split/gympac/page-001.pdf', pdfs: catalogPages('gympac', 39) },
    { id: 37, brand: 'GYMXF', cat: '完整型錄', title: 'GYMXF Commercial Fitness / 完整型錄', desc: 'GYMXF RIG、訓練架、機台、自由重量、配件與地材，共 46 頁。', img: 'assets/catalog/gymxf-rig.jpg', pdf: 'assets/catalog/pdf/split/gymxf/page-001.pdf', pdfs: catalogPages('gymxf', 46) },
    { id: 38, brand: 'CROSSMAX', cat: '完整型錄', title: 'Kids Fitness / 兒童體適能完整型錄', desc: '兒童體適能、快樂體操、軟式器材、敏捷與平衡訓練設備，共 7 頁。', img: 'assets/catalog/kids-flooring.jpg', pdf: 'assets/catalog/pdf/split/kids/page-001.pdf', pdfs: catalogPages('kids', 7) }
  ];
